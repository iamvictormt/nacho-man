...
export const allProducts: Product[] = [
  ...
  },
  {
    ...
    description: "Receita tex-mex com carne bovina moída, feijão e temperos selecionados.",
    price: 34.9,
    priceUnit: "KG",
    category: "CONGELADO",
    subcategory: "Carnes",
  ...
  },
  {
    ...
    description: "Carne suína cozida, desfiada e temperada com barbecue, com sabor marcante e textura macia.",
    price: 39.9,
    priceUnit: "KG",
    category: "CONGELADO",
    subcategory: "Carnes",
  ...
  },
  {
    ...
    description: "Proteína vegetal texturizada cuidadosamente temperada, ideal para diversas aplicações culinárias.",
    price: 19.9,
    priceUnit: "KG",
    category: "CONGELADO",
  ...
  },
  {
    ...
    description: "Frango cozido e desfiado, envolvido em molho saboroso e levemente condimentado.",
    price: 42.9,
    priceUnit: "KG",
    category: "CONGELADO",
    subcategory: "Carnes",
  ...
  },
  {
    ...
    description: "Feijão carioca preparado até atingir textura cremosa e sabor equilibrado.",
    price: 14.9,
    priceUnit: "KG",
    category: "CONGELADO",
  ...
  },
  {
    ...
    description: "Frango empanado com tempero levemente picante, congelado e pronto para preparo.",
    price: 43.9,
    priceUnit: "KG",
    category: "CONGELADO",
    subcategory: "Carnes",
  ...
  },
  {
    ...
    description: "Massa tradicional de churros, congelada e pronta para fritura.",
    price: 14.9,
    priceUnit: "KG",
    category: "CONGELADO",
    subcategory: "Doces",
  ...
  },
  {
    ...
    description: "Massa tradicional de churros, congelada, com 10 cm. Pronta para fritar e rechear.",
    price: 14.9,
    priceUnit: "KG",
    category: "CONGELADO",
    subcategory: "Doces",
  ...
  },
  {
    ...
    description: "Geleia de frutas com toque picante. Ideal para preparo de drinks e sobremesas.",
    price: 15.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Molhos",
  ...
  },
  {
    ...
    description: "Preparado concentrado sabor bacon. Um kit rende até 2L de maionese pronta.",
    price: 29.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Kits",
  ...
  },
  {
    slug: "jalapeno-2l",
    name: "Jalapeño 2L",
    description: "Versão food service do molho de pimenta jalapeño e alho com sabor marcante.",
    price: 79.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Food Service",
  ...
  },
  {
    slug: "sweet-chili-2l",
    name: "Sweet Chili 2L",
    description: "Versão food service do molho agridoce de pimenta, levemente picante.",
    price: 41.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Food Service",
  ...
  },
  {
    slug: "roja-1l",
    name: "Roja 1L",
    description: "Molho de pimenta jalapeño vermelho, inspirado na culinária mexicana, estilo Sriracha.",
    price: 29.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Food Service",
  ...
  },
  {
    ...
    description: "Molho à base de picles e pimenta jalapeño, com sabor agridoce e toque picante.",
    price: 13.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Molhos",
  ...
  },
  {
    ...
    description: "Molho que combina o sabor tropical de abacaxi com pimenta habanero.",
    price: 9.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Molhos",
  ...
  },
  {
    ...
    description: "Molho de pimenta habanero chocolate com sabor intenso.",
    price: 13.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Molhos",
  ...
  },
  {
    ...
    description: "Combinação de açúcar e especiarias para finalização de churros e outras sobremesas.",
    price: 8.9,
    priceUnit: "UND",
    category: "SECO",
  ...
  },
  {
    ...
    description: "Combinação de temperos desenvolvida para realçar o sabor de batatas e porções.",
    price: 14.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Temperos",
  ...
  },
  {
    ...
    description: "Combinação de temperos desenvolvida para agregar sabor e personalidade a chips, snacks e petiscos.",
    price: 7.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Temperos",
  ...
  },
  {
    ...
    description: "Base concentrada para preparo de um arroz rápido e saboroso. Rende 900 g de arroz pronto.",
    price: 5.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Acompanhamentos",
  ...
  },
  {
    ...
    description: "Tempero mexicano cítrico com sal e pimentas, levemente picante.",
    price: 35.9,
    priceUnit: "UND",
    category: "SECO",
    subcategory: "Temperos",
...
export function getProductsByCategory(category: string): Product[] {
  return allProducts.filter((p) => p.category === category || p.subcategory === category)
}
...
const productDetailsBySlug = new Map(productDetails.map((product) => [product.slug, product]))
...
export const catalogProducts: CatalogProduct[] = allProducts.map((product) => {
  ...
  return {
    ...
    priceLabel: detail?.price ?? `${formatCatalogPrice(product.price)} / ${product.priceUnit}`,
    features: detail?.features ?? [product.description],
    applications: detail?.applications ?? [],
  }
})

export const catalogProductsBySlug = new Map(catalogProducts.map((product) => [product.slug, product]))
...
export function getRelatedProducts<T extends Product>(current: T, allProductsList: T[], max: number = 4): T[] {
